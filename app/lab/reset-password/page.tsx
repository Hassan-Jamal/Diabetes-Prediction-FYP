  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-slate-50 to-green-100 flex items-center justify-center">
        <Card className="border-2 border-emerald-200/50 bg-white/90 backdrop-blur-sm p-12 shadow-2xl max-w-md text-center">
      ...
      <main className="relative flex-1 flex items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="w-full max-w-lg">
          <div className="mb-8 flex justify-center">
            <div className="h-24 w-24 rounded-3xl bg-gradient-to-br from-emerald-600 to-green-600 flex items-center justify-center shadow-2xl">
